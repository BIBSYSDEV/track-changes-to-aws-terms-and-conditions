...
inconsistent with normal, individual use, or (c) resell the Chime PSTN Service
...
placing the call, or (b) engage in unusual calling patterns inconsistent with
normal, individual use.

...
**25.2.** If you use the Amazon AppStream 2.0 User Pool feature to enable End
...
that AWS provides under a statement of work (“SOW”), or via a Generative AI
Innovation Center engagement, to help you use the other Services. AWS
Professional Services are “Services” for purposes of the Agreement.
...
**45.5.** Other than Third Party Content, Content that AWS provides as part of
...
**60.3.8.** When using Nova customization on SageMaker Training Jobs or
